...
// 
//
// Related Topics 栈 树 字符串 二叉树 👍 489 👎 0


package com.jue.java.learn.leetcode.editor.cn.VerifyPreorderSerializationOfABinaryTree;
...
class Solution {
    public boolean isValidSerialization(String preorder) {
        ...
        for (String c : preorder.split(",")) {
            if ("#".equals(c)) {
                while (!root.isEmpty() && "#".equals(root.peek())) {
                    root.pop();
                    if (root.isEmpty()) {
                        return false;
                    }
        ...
        return root.size() == 1 && "#".equals(root.pop());
    }
}
