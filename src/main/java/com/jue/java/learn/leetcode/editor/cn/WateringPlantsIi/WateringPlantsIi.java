...
package com.jue.java.learn.leetcode.editor.cn.WateringPlantsIi;
...
public class WateringPlantsIi {
    public static void main(String[] args) {
        ...
        System.out.println(solution.minimumRefill(new int[]{2, 2, 3, 3}, 5, 5)); // 1
        System.out.println(solution.minimumRefill(new int[]{2, 2, 3, 3}, 3, 4)); // 2
        System.out.println(solution.minimumRefill(new int[]{5}, 10, 8)); // 0
    }
}
