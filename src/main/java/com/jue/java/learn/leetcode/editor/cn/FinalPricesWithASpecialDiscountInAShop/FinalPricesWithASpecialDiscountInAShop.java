...
// 
//
// Related Topics 栈 数组 单调栈 👍 146 👎 0


package com.jue.java.learn.leetcode.editor.cn.FinalPricesWithASpecialDiscountInAShop;
...
class Solution {
    public int[] finalPrices(int[] prices) {
        ...
        for (int i = 0; i < size - 1; i++) {
            ...
            result[i] = index < size ? prices[i] - prices[index] : prices[i];
        }
        return result;
    }
}
