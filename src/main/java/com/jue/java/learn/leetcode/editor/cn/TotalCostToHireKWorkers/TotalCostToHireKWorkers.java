...
// 
//
// Related Topics 数组 双指针 模拟 堆（优先队列） 👍 69 👎 0


package com.jue.java.learn.leetcode.editor.cn.TotalCostToHireKWorkers;
...
public class TotalCostToHireKWorkers {
    public static void main(String[] args) {
        ...
        System.out.println(solution.totalCost(new int[]{2, 2, 2, 2, 2, 2, 1, 4, 5, 5, 5, 5, 5, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2}, 7, 3));
    }
}
...
class Solution {
    public long totalCost(int[] costs, int k, int candidates) {
        ...
        while (l < candidates && l <= h) {
            queue.add(new int[]{costs[l], l, +1});
            if (l != h) {
                queue.add(new int[]{costs[h], h, -1});
            }
            l++;
            h--;
        }
