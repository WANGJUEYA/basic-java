...
// 
//
// Related Topics 多线程 👍 127 👎 0


package com.jue.java.learn.leetcode.editor.cn.TheDiningPhilosophers;
...
class DiningPhilosophers {
    ...
    // 五个勺子
    ReentrantLock[] locks = new ReentrantLock[TOTAL];
    // 最多让四个人同时就餐
    ...
    public void wantsToEat(int philosopher,
        ...
        try {
            ...
            locks[(philosopher + 1) % TOTAL].lock();
            pickLeftFork.run();
            pickRightFork.run();
            // 吃饭
            eat.run();
            ...
            locks[(philosopher + 1) % TOTAL].unlock();
            semaphore.release();
        } catch (Exception e) {
            e.printStackTrace();
        }
