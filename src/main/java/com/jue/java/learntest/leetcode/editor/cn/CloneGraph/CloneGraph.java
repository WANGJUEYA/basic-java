...
package com.jue.java.learntest.leetcode.editor.cn.CloneGraph;

import com.jue.java.learntest.tooffer.bean.Node;
...
//        System.out.println(node1.toString());
        ...
        int[][] array = new int[][]{{2, 4}, {1, 3}, {2, 4}, {1, 3}};
        System.out.println(Node.newInstance(array).toString());
    }
}
    ...
    public Node cloneGraph(Node node) {
        ...
        while (!stack.empty()) {
            ...
            for (Node nei : temp.neighbors) {
                ...
                map.get(temp.val).neighbors.add(map.get(nei.val));
            }
        }
